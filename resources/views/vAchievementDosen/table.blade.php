...
<h2>Lecturers Achievement Table</h2>
</div>
@if(session('info'))
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered">
                                ...
                                @if(count($data)>0)
                                    ...
                                    <tr>
                                      ...
                                      <td>
									      	              <a href='{{url("/admin/vAchievementDosen/read/{$dat->ID}")}}' class="label label-primary"><i class="glyphicon glyphicon-list-alt"></i> Read </a>  &nbsp;
