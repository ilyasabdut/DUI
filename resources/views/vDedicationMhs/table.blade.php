...
<h2>Student Social Engagement Table</h2>
</div>
@if(session('info'))
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered">
                                ...
                                @if(count($data)>0)
                                    ...
                                    <tr>
                                      ...
                                      <td>{{$dat->Tanggal}}</td>
                                      <td>
									      	              <a href='{{url("/admin/vDedicationMhs/read/{$dat->ID}")}}' class="label label-primary"><i class="glyphicon glyphicon-list-alt"></i> Read </a> &nbsp;
